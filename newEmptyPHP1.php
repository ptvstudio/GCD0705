...
<div id="prodcut-slider" class="carousel slide carousel-fade" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Images/Product1.png" class="d-block w-100">
    </div>
  </div>
</div>        
    </div>
    ...
    <p>Inspired by the ruffles of the most emblematic vintage cars and made with the latest technologies in the world of watchmaking, this Dakar special edition offers a magnificent modern reinterpretation of classicism.</p>  
    <hr>
    </div>
    <div class="container">
<div class="title-box">
